...
return [
    ...
    'narachka_columns' => ['phone', 'address', 'city','municipality','paid', 'tracking_code', 'nacin_na_plakanje' , 'doc_articles', 'total', 'naracka_ispratena_na', 'naracka_platena_na', 'posta']
