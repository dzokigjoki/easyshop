...
return [
    ...
    'narachka_columns' => ['phone','address','city','municipality', 'paid','tracking_code','doc_articles', 'nacin_na_plakanje' ,'total','naracka_ispratena_na','naracka_platena_na','posta']
