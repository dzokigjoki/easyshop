...
return [
    ...
    'brandRemoval' => false,
    'google_analytics' => 'UA-97088285-4',
    'pixel' => [
        'codes' => ['320701838398143', '1577352572314158'],
        'currency' => 'HRK',
    ],
    'prices' => [
        'retail1' => true,
    ...
    'currency' => 'HRK',
    'currency_select' => ['МКД', 'HRK', 'EUR', 'HRK'],
    ...
    'order' => [
        'warehouse_id' => 4, // Defailt warehouse when making orders from web
        'faktura_online'=>0,
