...
return [
    ...
    'promocija'  => false,
    'locale' => 'mk',
    'title_page' => 'Топ продукти',
    'logo' => '/assets/topprodukti/image/novo-logo-200x100.png',
    'faktura_ispratnica_documents' => false,
    'emailDomain' => 'topprodukti.mk',
    'brandRemoval' => false,
    'google_analytics' => 'UA-97088285-1',
    'pixel' => [
        'codes' => ['116018852203254'],
        'currency' => 'MKD',
    ],
    'prices' => [
        'retail1' => true,
    ...
    'posti'=> [
        ...
        'Express posta' => 'Express posta',
        'GLS Slovenija' => 'GLS Slovenija',
        'FHB Ceska, Slovacka' => 'FHB Ceska, Slovacka',
        'Fun Courrier' => 'Fun Courrier',
    ],
    'document_status' => [
    ...
    'order' => [
        ...
        'excel_columns' => [
            ...
            'address' => 'Adresa',
            'phone' => 'Tel',
            'topprodukti_tel_email' => 'SERVICES',
            'email' => 'Email',
    ...
    'narachka_columns' => ['phone','paid','tracking_code','doc_articles','total','naracka_ispratena_na','naracka_platena_na','posta']
];