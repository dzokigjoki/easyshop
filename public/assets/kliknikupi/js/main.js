 (function ($) {
    ...
    $document.ready(function () {
      ...
      if (blocks.navTabsCarusel.length) {
          ...
          // carousel($tab.find('.carousel-products'), 5, 5, 3, 3, 1);
          // carousel($tab.find('.carouselTab-col-4'), 4, 4, 3, 2, 1);
          carousel('.carousel-products', 5, 5, 3, 3, 1);
          carousel('.carouselTab-col-4', 4, 4, 3, 2, 1);
        });
      ...
      setSlickGallery($('.carousel-products-5'), 5, 5, 3, 3, 1, 'carousel');
    ...
    function countDown(showZero) {
        ...
        blocks.countdown.each(function() {
            var $this = $(this),
              date = $this.data('date'),
              set_year = $this.data('year') || 'Год.',
              set_month = $this.data('month') || 'Мес.',
              set_week = $this.data('week') || 'Нед.',
              set_day = $this.data('day') || 'Ден',
              set_hour = $this.data('hour') || 'Час',
              set_minute = $this.data('minute') || 'Мин.',
              set_second = $this.data('second') || 'Сек.';
