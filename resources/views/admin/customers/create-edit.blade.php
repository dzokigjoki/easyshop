...
<form method="post" action="{{URL::to('admin/customers/store')}}">
    <div class="portlet light col-md-12">
        <div class="portlet-title">
        <div class="caption">
        @if($user_id > 0 )
             <i class="fa fa-user"></i>Измени податоци за клиент </div>
        @else
            <i class="fa fa-user"></i>Нов Клиент </div>
        @endif
        ...
        <div class="form-group col-md-12">
            ...
            <div class="col-md-8  @if($errors->has('email')) has-error  @endif">
                <div class="input-group">
                    ...
                    <input name="email" type="email" class="form-control" placeholder="Е-пошта" value="{{ old('email', $client->email) }}"> </div>
                </div>
            </div>
        <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            <div class="col-md-8 @if($errors->has('phone2')) has-error  @endif">
                <input type="text" class="form-control" placeholder="Телефон 2" name="phone2" value="{{ old('phone2', $client->phone2) }}">
            </div>
        </div>
        @endif
        @if(config('app.client') == EasyShop\Models\Settings::CLIENT_NATURATHERAPYSHOP)
            <div class="form-group col-md-12">
                ...
                <div class="col-md-8 @if($errors->has('loyalty_code')) has-error  @endif">
                    <input type="text" class="form-control" placeholder="Лојалти шифра" name="loyalty_code" value="{{ old('loyalty_code', $client->loyalty_code) }}">
                </div>
            </div>
            @if(auth()->user()->canDo('admin'))
            <div class="form-group col-md-12">
                <label class="col-md-4 control-label">Лојалти поени:</label>
                <div class="col-md-8">
                    <input type="text" class="form-control" placeholder="Лојалти поени" name="loyalty_points" value="{{ old('loyalty_points', $client->points) }}">
                </div>
            </div>
            @endif
        @endif
        <div class="form-group col-md-12">
            ...
            <div class="col-md-8">
                <select id="user_type" class="form-control select2" name="type">
                    <option  @if(isset($client->type) && $client->type == 'person' ) selected @endif  value="person">Физичко лице</option>
                    <option  @if(isset($client->type) && $client->type == 'company' ) selected @endif  value="company">Правно лице</option>                                          
                </select>
            </div>
        </div>
        ...
        <div class="form-group col-md-12">
            <label class="col-md-4 control-label">Партнер:</label>
            <div class="col-md-3">
                <input name="partner"
                       type="checkbox"
                       class="make-switch"
                       ...
                       data-off-text="Не"
                       value="1"
                       @if(isset($client->partner) && $client->partner == 1) checked @endif
                      >
            </div>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <div class="col-md-3">
                <input name="aktiven"
                       ...
                       data-off-text="Не"
                       value="1"
                       @if(isset($client->aktiven) && $client->aktiven == 1) checked @endif
                      >
            </div>
        </div>
        <div class="form-group col-md-12">
        <label class="col-md-4 control-label">Ценовна група:</label>
<?php $global_prices = \EasyShop\Models\AdminSettings::getField('prices'); ?>
        <div class="col-md-8">
                 <select class="form-control select2" name="cenovna_grupa">
@if(!empty($global_prices['retail1']))
                    <option  @if(isset($client->cenovna_grupa) && $client->cenovna_grupa == 'price_retail_1') selected @endif  value="price_retail_1">Малопродажна 1</option>
@endif
@if(!empty($global_prices['retail2']))
                    <option @if(isset($client->cenovna_grupa) && $client->cenovna_grupa == 'price_retail_2') selected @endif  value="price_retail_2">Малопродажна 2</option>
@endif
@if(!empty($global_prices['wholesale1']))
                    <option @if(isset($client->cenovna_grupa) && $client->cenovna_grupa == 'price_wholesale_1') selected @endif  value="price_wholesale_1">Големопродажна 1</option>
@endif
@if(!empty($global_prices['wholesale2']))
                    <option @if(isset($client->cenovna_grupa) && $client->cenovna_grupa == 'price_wholesale_2') selected @endif  value="price_wholesale_2">Големопродажна 2</option>
@endif
@if(!empty($global_prices['wholesale3']))
                    <option @if(isset($client->cenovna_grupa) && $client->cenovna_grupa == 'price_wholesale_3') selected @endif  value="price_wholesale_3">Големопродажна 3</option>
@endif
                </select>
            </div>
        </div>
        ...
        <div class="form-group col-md-12">
         ...
         <div class="form-group col-md-12">            
            ...
            <div id="mkd_gradovi_shipping" style="@if($client->country_shipping_id != 1) display:none @endif" class="form-group col-md-12">
                <label class="col-md-4 control-label">Град:</label>
                <div class="col-md-8">
            ...
            <div class="form-group col-md-12 city_other_shipping" style="@if($client->country_shipping_id == 1) display:none @endif">
                <label class="col-md-4 control-label">Град:</label>
        ...
        @if(in_array(config('app.client'), \EasyShop\Models\Settings::CLIENT_NATURATHERAPY_SHOPS))
        <div class="form-group col-md-12" @if(!auth()->user()->canDo('admin')) style = "display: none"@endif>
            <label class="col-md-4 control-label">Оператор:</label>
            <div class="col-md-8">
                <select name="operator" class="form-control select2">
                    <option value="" selected>Избери</option>   
                    @foreach( $operators as $operator)
                    <option @if(isset($client->created_by) && $client->created_by == $operator->id) selected @endif value="{{ $operator->id }}">{{ $operator->first_name }} {{ $operator->last_name }}</option>
                    @endforeach
                </select>
            </div>
