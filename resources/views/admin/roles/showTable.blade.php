            ...
            <div class="col-md-12">
                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                           <a class="btn btn-success" href="{{ route('admin.roles.create') }}"><i class="fa fa-plus"></i>Нов Role</a> 
                        </div>
                    </div>
                    <div class="portlet-body">
                        <table articles-table class="table table-striped table-bordered table-hover order-column">
                            ...
                            <tr role="row" class="heading">
                                <th class="tooltips" data-container="body" data-placement="top" data-original-title="Емаил"> Role</th>
                                <th class="tooltips text-center" data-container="body" data-placement="top" data-original-title="Активен"> Креирана</th>
