                            ...
                            <div class="tabbable-line">
                                <div class="tab-pane active" id="tab_general">
                                    <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5 @if($errors->has('name')) has-error  @endif">
                                                    <input id="name" type="text" class="form-control" name="name"
                                                        value="{{ $sticker->name }}" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5 @if($errors->has('form')) has-error  @endif">
                                                    <select class="form-control" name="form" id="form">
                                                        ...
                                                        <option @if($sticker->form == 'square') selected @endif
                                                            value="square">
                                                            Квадрат
                                                        </option>
                                                        <option @if($sticker->form == 'circle') selected @endif
                                                            value="circle">
                                                            Круг
                                                        </option>
                                                        <option @if($sticker->form == 'rectangle') selected @endif
                                                            value="rectangle">
                                                            Правоаголник
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5 @if($errors->has('position')) has-error  @endif">
                                                    <select class="form-control" name="position" id="position">
                                                        <option value="" disabled>Избери</option>
                                                        <option @if($sticker->position == 'top-left') selected @endif
                                                            value="top-left">
                                                            Горе лево
                                                        </option>
                                                        <option @if($sticker->position == 'top-right') selected @endif
                                                            value="top-right">
                                                            Горе десно
                                                        </option>
                                                        <option @if($sticker->position == 'bottom-left') selected @endif
                                                            value="bottom-left">
                                                            Долу лево
                                                        </option>
                                                        <option @if($sticker->position == 'bottom-right') selected
                                                            @endif value="bottom-right">
                                                            Долу десно
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-5 @if($errors->has('content')) has-error  @endif">
                                                    <select class="form-control" name="content" id="content">
                                                        <option value="" disabled>Избери</option>
                                                        <option @if($sticker->content == 'new') selected @endif
                                                            value="new">
                                                            Ново
                                                        </option>
                                                        <option @if($sticker->content == 'recommended') selected @endif
                                                            value="recommended">
                                                            Препорачано
                                                        </option>
                                                        <option @if($sticker->content == 'sale') selected @endif
                                                            value="sale">
                                                            Распродажба
                                                        </option>
                                                        <option @if($sticker->content == 'discount') selected @endif
                                                            value="discount">
                                                            Попуст
                                                        </option>
                                                        <option @if($sticker->content == 'near_end_stock') selected
                                                            @endif value="near_end_stock">
                                                            При крај на залиха
                                                        </option>
                                                    </select>
                                                </div>
                                        ...
                                        <input type="hidden" id="stickerColor" value="{{ $sticker->color }}">
