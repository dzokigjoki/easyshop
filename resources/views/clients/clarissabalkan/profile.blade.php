...
<main class="bg_gray">
    <div class="container margin_30">
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-10 col-md-10 offset-lg-1">
                ...
                <div class="box_account">
                    ...
                    <form method="post" action="{{ route('profiles.store') }}" class="type_2">
                        ...
                        <div class="form_container">
                            ...
                            <div class="private box">
                                <div class="row no-gutters">
                                    <div class="col-6 pr-1">
                                        <div class="form-group">
                                            <input type="text" required class="form-control" name="first_name" value="{{ old('first_name', $client->first_name) }}"
                                    ...
                                    <div class="col-6 pl-1">
                                        <div class="form-group">
                                            <input type="text" required class="form-control" name="last_name"
                                                id="last_name" value="{{ old('last_name', $client->last_name) }}" placeholder="Презиме*">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <input type="email" disabled class="form-control" value="{{ old('email', $client->email) }}" name="email" id="email"
                                    placeholder="E- пошта*">
                            </div>
                            <div class="form-group">
