        ...
        <div class="container relative">
            ...
            <div class="row">
                ...
                <aside class="col-md-3 col-xs-12  sidebar left-sidebar">
                    ...
                    @if (count($filters))
                    <h2 class="bottom-line pb-10 pb-sml-10 full-grey">Филтри</h2>
                ...
                <div class="col-md-9 col-xs-12 pt-sml-20 catalogue-colmb-50">
                    <div class="shop-catalogue grid-view">

                        <div data-products-list="">
                            
                                @include('clients.david_kompjuteri.partials.category-products-list')
