	...
	<div id="pageWrapper">
		...
		<main>
			...
			<section class="introBlock position-relative">
				...
				{{--	<div>
						 <div class="align w-100 d-flex align-items-center bgCover" style="background-image:url({{ url_assets('/e-commerce/images/b-bg.jpg') }})">
								...
								<div class="row">
									<div class="col-12 col-xl-7">
										<div class="txtwrap pr-lg-10">
											<h1 class="fwEbold position-relative pb-lg-8 pb-4 mb-xl-7 mb-lg-6">Natural beauty is the best beauty<span class="text-break d-block"></span></h1>
											<p class="mb-xl-15 mb-lg-10">Our products are made with natural extracts<br>it has been the industry's standard.</p>
									...
									<div class="imgHolder">
										<img src="{{ url_assets('/e-commerce/images/homepic1.png') }}" alt="homepic1"
											class="img-fluid">
									</div>
								</div>
							</div>
						...
						<div class="align w-100 d-flex align-items-center bgCover" style="background-image:url({{ url_assets('/e-commerce/images/b-bg2.jpg') }})">
							...
							<div class="container position-relative holder pt-xl-10 pt-0">
								...
								<div class="row">
									...
									<div class="imgHolder">
										<img src="{{ url_assets('/e-commerce/images/homepic2.png') }}" alt="homepic2"
			...
			<section class="chooseUs-sec container pt-xl-22 pt-lg-20 pt-md-16 pt-10 pb-xl-12 pb-md-7 pb-2">
				<div class="row">
					<div class="col-12 col-lg-6 mb-lg-0 mb-4">
						<img src="{{ url_assets('/e-commerce/images/whychooseus.jpg') }}" alt="image description" class="img-fluid">
					</div>
				...
				<div class="dealSlider w-100 px-lg-10 px-md-5">
					...
					<div>
						...
						<div class="featureCol px-3 w-100 mb-sm-8 mb-6">
							<div class="border">
								<div class="imgHolder position-relative w-100 overflow-hidden">
									<img src="{{ url_assets('/e-commerce/images/signature.png') }}" alt="image description" class="img-fluid w-100">
									<ul class="list-unstyled postHoverLinskList d-flex justify-content-center m-0">
										<li class="mr-2 overflow-hidden"><a href="javascript:void(0);" class="icon-heart d-block"></a></li>
										<li class="mr-2 overflow-hidden"><a href="javascript:void(0);" class="icon-cart d-block"></a></li>
										<li class="mr-2 overflow-hidden"><a href="javascript:void(0);" class="icon-eye d-block"></a></li>
						...
						<div class="partnerSlider d-flex flex-wrap">
							<div>
								<div class="logoColumn d-flex align-items-center justify-content-center">
									<a href="javascript:void(0);"><img src="{{ url_assets('/e-commerce/images/brand1.png') }}" alt="Partner Logo" class="img-fluid"></a>
								</div>
							</div>
							<div>
								<div class="logoColumn d-flex align-items-center justify-content-center">
									<a href="javascript:void(0);"><img src="{{ url_assets('/e-commerce/images/brand2.png') }}" alt="Partner Logo" class="img-fluid"></a>
								</div>
							</div>
							<div>
								<div class="logoColumn d-flex align-items-center justify-content-center">
									<a href="javascript:void(0);"><img src="{{ url_assets('/e-commerce/images/brand3.png') }}" alt="Partner Logo" class="img-fluid"></a>
								</div>
							</div>
							<div>
								<div class="logoColumn d-flex align-items-center justify-content-center">
									<a href="javascript:void(0);"><img src="{{ url_assets('/e-commerce/images/brand4.png') }}" alt="Partner Logo" class="img-fluid"></a>
								</div>
							</div>
							<div>
								<div class="logoColumn d-flex align-items-center justify-content-center">
									<a href="javascript:void(0);"><img src="{{ url_assets('/e-commerce/images/brand5.png') }}" alt="Partner Logo" class="img-fluid"></a>
								</div>
							</div>
							<div>
								<div class="logoColumn d-flex align-items-center justify-content-center">
									<a href="javascript:void(0);"><img src="{{ url_assets('/e-commerce/images/brand6.png') }}" alt="Partner Logo" class="img-fluid"></a>
								</div>
							</div>
