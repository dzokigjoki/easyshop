        ...
        <div class="row">
            ...
            <div class="column width-12 content-inner">
                ...
                <div class="section-block no-padding column width-7" id="search-grid">
                    <div class="row"><br><br>
                        <div class="column width-12">
                            <h3 class="mb-30 color-grey">Пребарај повторно</h3>
                                            ...
                                            <div class="thumbnail product-thumbnail img-scale-in" data-hover-easing="easeInOut"
                                                ...
                                                <a class="overlay-link"
                                                   href="{{route('product', [$product->id, $product->url])}}">
                                                    <img style="min-height: 350px;" src="{{\ImagesHelper::getProductImage($product,null,'lg_')}}"
                                                         class="item-image">
                                                </a>
                                                <div class="product-actions center">
                                                    <a href="{{route('product', [$product->id, $product->url])}}" class="hoverCrno button pill add-to-cart-button">Прегледај</a>
                                                </div>
                                            </div>

                                            <div class="product-details center">

                                                <button value="{{$product->id}}" data-add-to-cart="" id="add_to_cart" class="hoverCrno button pill add-to-cart-button">Додади во Кошничка</button>
                                                <br>
                                                <br>
