    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-3 no-margin sidebar narrow">
            ...
            <div class="widget">
                <div class="simple-banner">
                    <a href="#"><img alt="" class="img-responsive" src="/assets/tehnopolis/images/blank.gif" data-echo="/assets/tehnopolis/images/banners/banner-simple.jpg" /></a>
                </div>
            </div>
            <!-- ========================================= FEATURED PRODUCTS ========================================= -->
            <div class="widget">
        ...
        <div class="col-xs-12 col-sm-9 no-margin wide sidebar">
            ...
            <div id="grid-page-banner">
                <a href="#">
                    <img src="/assets/tehnopolis/images/banners/banner-gamer.jpg" alt="" />
                </a>
            </div>
                                ...
                                <div class="row no-margin">
                                    ...
                                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                        <div class="product-item">
                                            ...
                                            <div class="image">
                                                <img alt="" src="/assets/tehnopolis/images/blank.gif" data-echo="/assets/tehnopolis/images/products/product-02.jpg" />
                                            </div>
                                            <div class="body">
                                    ...
                                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                        <div class="product-item">
                                            <div class="image">
                                                <img alt="" src="/assets/tehnopolis/images/blank.gif" data-echo="/assets/tehnopolis/images/products/product-03.jpg" />
                                            </div>
                                            <div class="body">
                                                <div class="label-discount clear"></div>
                                                <div class="title">
                                    ...
                                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                        <div class="product-item">
                                            ...
                                            <div class="image">
                                                <img alt="" src="/assets/tehnopolis/images/blank.gif" data-echo="/assets/tehnopolis/images/products/product-04.jpg" />
                                            </div>
                                            <div class="body">
                                                <div class="label-discount clear"></div>
                                                <div class="title">
                            ...
                            <div class="products-list">
                                ...
                                <div class="product-item product-item-holder">
                                    ...
                                    <div class="row">
                                        <div class="no-margin col-xs-12 col-sm-4 image-holder">
                                            <div class="image">
                                                <img alt="" src="/assets/tehnopolis/images/blank.gif" data-echo="/assets/tehnopolis/images/products/product-05.jpg" />
                                            </div>
                                        </div><!-- /.image-holder -->
                                        <div class="no-margin col-xs-12 col-sm-5 body-holder">
                                            <div class="body">
