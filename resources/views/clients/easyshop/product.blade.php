    ...
    <div class="container">
                ...
                <div id="owl-single-product">
                    <div class="single-product-gallery-item" id="slide1">
                        <a data-rel="prettyphoto" href="images/products/product-gallery-01.jpg">
                            <img class="img-responsive" alt="" src="/assets/tehnopolis/images/blank.gif" data-echo="/assets/tehnopolis/images/products/product-gallery-01.jpg" />
                        </a>
                ...
                <div class="single-product-gallery-thumbs gallery-thumbs">
                    ...
                    <div id="owl-single-product-thumbnails">
                        <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="0" href="#slide1">
                            <img width="67" alt="" src="/assets/tehnopolis/images/blank.gif" data-echo="/assets/tehnopolis/images/products/gallery-thumb-01.jpg" />
                        </a>
        ...
        <div class="no-margin col-xs-12 col-sm-7 body-holder">
            <div class="body">
                ...
                <div class="prices">
                    <div class="price-current">1740 мкд</div>
                    <div class="price-prev">2199 мкд</div>
                </div>
                        ...
                        {{--<div class="comment-item">--}}
                            {{--<div class="row no-margin">--}}
                                {{--<div class="col-lg-1 col-xs-12 col-sm-2 no-margin">--}}
                                    {{--<div class="avatar">--}}
                                        {{--<img alt="avatar" src="/assets/tehnopolis/images/default-avatar.jpg">--}}
                                    {{--</div><!-- /.avatar -->--}}
                                {{--</div><!-- /.col -->--}}
            ...
            <div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
                <div class="no-margin carousel-item product-item-holder size-small hover">
                    <div class="product-item">
                        ...
                        <div class="prices">
                            <div class="price-current text-right">1199 мкд</div>
                        </div>
