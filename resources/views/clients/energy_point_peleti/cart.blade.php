                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        <a href="{{ $product->url }}">
                                            ...
                                            @else
                                            src="{{ url_assets('/energy_point_peleti/images/product/product-1.jpg')}}"
                                            @endif
                                            />
                                    </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div style="display:flex; align-items:center;">Начин на плаќање: <br>
                                        ...
                                        <input @if($i['name']=='halk' ) class="" @endif
                                            style="margin-top:0; margin-left: 10px;" type="radio" checked="checked"
                                            name="paymentType" value="{{$i['name']}}" @if(isset($formData) &&
                                            isset($formData['paymentType']) && $formData['paymentType']===$i['name'])
                                            checked="checked" @endif @if (!isset($formData) && $i['name']==='casys' )
                                            checked="checked" @endif />
                                        <span @if($i['name']=='halk' ) class="" @endif
