...
@section('content')
<link rel='stylesheet' href='{{url_assets('/energy_point_peleti/css/shop.css')}}' type='text/css' media='all' />
<div class="container">
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-3 sidebar-wrap">
                ...
                <div class="main-sidebar collapse" id="filters">
                    @include('clients.energy_point_peleti.category-list-article-leftSide')
                </div>
            </div>
                ...
                <div class="main-content">
                    <div class="shop-loop grid">
                        <div data-products-list="">
                            @include('clients.energy_point_peleti.partials.category-products-list')
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
<script type='text/javascript' src='{{url_assets('/energy_point_peleti/js/core.min.js')}}'></script>
<script type='text/javascript' src='{{url_assets('/energy_point_peleti/js/widget.min.js')}}'></script>
<script type='text/javascript' src='{{url_assets('/energy_point_peleti/js/mouse.min.js')}}'></script>
<script type='text/javascript' src='{{url_assets('/energy_point_peleti/js/slider.min.js')}}'></script>
<script type='text/javascript' src='{{url_assets('/energy_point_peleti/js/jquery-ui-touch-punch.min.js')}}'></script>
<script type='text/javascript' src='{{url_assets('/energy_point_peleti/js/price-slider.js')}}'></script>
@stop