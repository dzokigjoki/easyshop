                ...
                <div class="footer-widget-col col-md-3 col-sm-6">
                    <div class="widget widget_text">
                        ...
                        {{-- <p><i class="fa fa-map-marker"></i> Железничка 6, 6000 Охрид</p> --}}
                            <p><i class="fa fa-phone"></i><a href="tel:0038975261552"> +123 456 789</a></p>
                            <p><i class="fa fa-phone"></i><a href="tel:0038971231807"> +123 456 789</a></p>
                            <p><i class="fa fa-envelope"></i> <a href="mailto:info@energy_point_peleti.com"> info@energy_point_peleti.com</a>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="textwidget textwidget_footer_photo mt-30 fb5SE col-sm-3 mt-45 col-md-3">
                            <div class="gettouch">
                                <div style="border:none; margin-left:-14px; overflow:hidden; width:270px !important; height:216px !important;"
                                    class="fb-page fb_widget" data-href="https://www.facebook.com/energy_point_peletimk/"
                                    data-small-header="false" data-adapt-container-width="true" data-hide-cover="false"
                                    data-show-facepile="true">
                                    <blockquote cite="https://www.facebook.com/energy_point_peletimk/"
                                        class="fb-xfbml-parse-ignore"><a
                                            href="https://www.facebook.com/energy_point_peletimk/">Energy Point Peleti MK</a></blockquote>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="row">
                        ...
                        <div class="pt-5 col-lg-6 col-md-6 col-sm-12 copyright">© {{date('Y')}} Energy Point Peleti. Сите права задржани.</div>
                    </div>
                </div>
            </div>
        </div>
