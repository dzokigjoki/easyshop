                        ...
                        <header>
                            ...
                            <div class="col-md-4" style="">
                                <input class="form-control"
                                       style="max-width: calc(100% - 90px); float: left; margin-top: 25px; " type="text"
                                       name="search"
                                       value="{{$search}}"/>
                                <button type="submit" class="search-submit" style="display: inline; margin-top: 25px;"
                                        id="baraj">Барај
                                </button>
                            </div>
                            <div>
                                <div class="flat-top-bar-shop flat-reset">
                                    ...
                                    <div style="float:left;" class="clearfix">
                                        <input style="height: 35px; float: left;" type="search"
                                               class="mobileSearch form-control search-field"
                                               value="{{$search}}" name="search">
                                        <button style="height: 35px; float: left;" type="submit" class="search-submit">
                                            <i style="float:left; width: 50px;" class="fa fa-search"></i></button>
                                    </div>
                                            ...
                                            @foreach($products as $product)
                                                @foreach ($products as $product)
                                                    ...
                                                    <li class="item col-md-3">
                                                        <div class="item-inner ipadWidth">
                                                            <div class="item-img">
                                                            ...
                                                            <div class="info-inner" style="text-align: center;">
                                                                ...
                                                                <button value="{{$product->id}}"  data-add-to-cart="" id="add_to_cart" style="padding-bottom: 15px;" class="buy_home"><i class="fa fa-shopping-cart"></i>
                                                                    <span>Додади во кошничка</span></button>
                                                                <div class="item-title" style="text-align: center; padding-top: 15px;">
