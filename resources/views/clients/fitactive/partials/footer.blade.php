                        ...
                        <div class="row">
                            <div class="hidden-xs col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <div class="ps-site-info Box p_10">
                                    <div class="Title D4879 ST15" style="color:#2c2c2c">Fit Active</div>
                                    ...
                                    <a class="pl-10" href="#" target="_blank"><i
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 ">
                                <div class="ps-site-info p_10 Box">
                                    ...
                                    <ul class="collapse display_show in" id="collapseCategories">
                                        ...
                                        <li class="Item">
                                            <a href="/politika-na-privatnost" class="Link D4879 ST16" style="color:#2c2c2c">Политика на приватност</a>
                                        </li>
                                        <li class="Item">
                                            <a href="/politika-na-kolacinja" class="Link D4879 ST16" style="color:#2c2c2c">Политика на колачиња</a>
                                        </li>
                                        <ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="collapse display_show" id="collapseContact">
                                        <li class="Item">
                                            <span class="bold">
                                                ...
                                                Ул. Франклин Рузвелт Број 8 1/13</span>
                                        </li>
                                        <li class="Item">
                                            <span class="bold"> 
                                                <a href="tel:38575339499">
                                                    <i class="fa fa-phone mobile-footer-icon"></i>
                                                    <span class="bold">075/339-499</span> &nbsp;
                                                </a>
                                                <a href="tel:38975339299">
                                                    <i class="fa fa-phone mobile-footer-icon"></i>
                                                    <span class="bold">075/339-299</span> 
                                                    </a>
                                            </span>
                                        </li>
                                        <li class="Item">
            ...
            <div style="padding-top: 30px; padding-bottom: 30px;" class="Container W1181">
                <div class="row">
                    ...
                    <div class="c-md-5 c-sm-5 text-right  app-phone-container">
                        <h4 class="text-left text_footer_right">Купувајте едноставно online</h4>
                    </div>
                </div>
            </div>
        </div> --}}
            ...
            <div class="text-center ps-footer__copyright">
                <div class="ps-container-fluid">
                    <div class="flex-center row">
                        <div class="col-lg-4 text-left col-md-4 col-sm-4 col-xs-12" style="padding:8px" id="copyright">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="payment-methods">
                             ...
                             <ul class="ps-footer__social">
                                <li>
                                    <a class="black-color" id="pravila-na-kupuvanje"
                                        href="/b/2/pravila-na-kupuvanje"></a>
                                    </li>
                                <li>
                                    <a class="black-color" id="politika-na-privatnost"
                                        href="/b/1/politika-na-privatnost"></a>
                                    </li>
                            </ul>
                        </div>
                    </div>
