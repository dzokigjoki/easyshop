  ...
  {{-- <div class="flex-center-header ps-container-fluid" id="top-nav">
    <div class="left">
      <span class="item-label">
        <a href="/contact">
          <img class="top-header-img" src="{{url_assets('/fitactive/images/icons/help.png')}}" alt=""> Помош</a>
      </span>
      <span class="item-label">
        <a href="/contact">
          <img class="top-header-img" src="{{url_assets('/fitactive/images/icons/package.png')}}" alt=""> Следење на нарачка</a>
      </span>
    </div>
    <div class="right">
      <span class="item-label">
        <a href="tel:38575339499">
          ...
          <span class="">075/339-499</span> &nbsp;
      </a>
      <a href="tel:38975339299">
          <i class="fa fa-phone mobile-footer-icon"></i>
          <span class="">075/339-299</span> 
          </a>
      </span>
    </div>
  </div> --}}
    ...
    <div class="flex-center-header ps-container-fluid">
      ...
      <div class="center">
        <a class="ps-logo" href="/">
          <img width="220" src="{{url_assets('/fitactive/images/logo.png')}}" alt="">
        </a>
      </div>
        ...
        <ul style="align-items: center !important" class="flex-end text-right header__actions">
          ...
          <li class="header__user"><a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="shopping-action"><i class="exist-user"></i></a>
            <ul class="dropdown-menu" aria-labelledby="shopping-action" id="shopping-action">
              ...
              <li><a href="/register4">Регистрација</a></li>
              @endif
            </ul>
          </li>
          <?php
         ...
         <li class="menu-item-has-children dropdown">
          ...
          {{-- <ul class="sub-menu">
            <li>
              ...
              <a href="mailto:info@fitactive.mk"><i class="fa fa-envelope dropdown-contact"></i>info@fitactive.mk</a>
            </li>
          </ul> --}}
        </li> 
{{-- 
        <li class="menu-item-has-children dropdown">
          ...
          <ul class="sub-menu">
            <li>
              <a href="tel:0038975339499"><i class="fa fa-phone dropdown-contact"></i>075/339-499</a>
              <a href="tel:0038975339299"><i class="fa fa-phone dropdown-contact"></i>075/339-299</a>
              <a href="mailto:info@fitactive.mk"><i class="fa fa-envelope dropdown-contact"></i>info@fitactive.mk</a>
            </li>
          </ul>
        </li>  --}}
