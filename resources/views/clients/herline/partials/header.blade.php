<header class="header-container header-type-default header-default-center header-navbar-default header-scroll-resize">
    <div class="topbar">
        <div class="container topbar-wap">
            <div class="row">
                <div style="display: flex; justify-content: flex-end; padding: 0;" class="col-sm-12">
                    <div class="right-topbar">
                            ...
                            <ul class="nav top-nav">
                                <li class="menu-item-has-children dropdown">
                                    ...
                                    <?php
                                      ...
                                      ?>
                                    <a style="padding: 0 15px;" href="{{route('profiles.get')}}" class=""><i
                                            class="dropdown-hover loggedUser fa fa-user"></i>{{ auth()->user()->first_name . " " . auth()->user()->last_name }}</a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="{{route('profiles.get')}}">Профил</a>
                                            <a href="{{route('order.history')}}">Историја на нарачки</a>
                                            <a href="{{route('auth.logout.get')}}">Одјава</a>
                                        </li>
                                    </ul>
                                    @else
                                    <a style="padding: 0 15px;" href="/login"><i class="fa fa-user"></i> Најава/
                                        Регистрација</a>
                                    @endif
                                </li>
                            </ul>
                        ...
                        <div class="user-wishlist">
                            <a href="/wishlist"><i class="fa fa-heart-o"></i> Листа на желби</a>
                        </div>
                        @endif
                    </div>
                </div>
                                ...
                                <div class="navbar-minicart navbar-minicart-topbar">
                                    <div class="navbar-minicart">
                                        ...
                                        <div class="minicart" id="shoppingCart">
                                            @include('clients.herline.cart-partial')
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="hidden-xs col-sm-2 col-right-topbar">
                            <div class="right-topbar">
                                ...
                                <a class="navbar-brand" href="/">
                                    <img class="logo" alt="Herline" id="header-desktop-logo"
                                        src="{{url_assets('/herline/images/logo.png')}}">
                                    <img class="logo-fixed" alt="Herline"
                                        src="{{url_assets('/herline/images/logo.png')}}">
                                    <img id="logo-mobile" class="logo-mobile" alt="Herline"
                                        src="{{url_assets('/herline/images/logo.png')}}">
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="navbar-header">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-4 visible-xs text-center">
                                            <a href="/">
                                                <img id="mobile-logo" src="{{url_assets('/herline/images/logo.png')}}"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="col-xs-4">
                                    ...
                                    <ul class="nav navbar-nav primary-nav">
                                        ...
                                        <li>
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-hover "
                                                        href="{{route('category', [$ch['id'], $ch['url']])}}">{{$ch['title']}}</a>
                                                        @if(isset($ch['children']))
                                                        <ul class="dropdown-menu desnoMenu">
                                                            @foreach($ch['children'] as $subch)
                                                            <li><a
                                                                    href="{{route('category', [$subch['id'], $subch['url']])}}">{{$subch['title']}}</a>
                                                            </li>
                                                            @endforeach
                                                        </ul>
                                                        @endif
