    ...
    <div class="offcanvas-wrap">
        ...
        <nav class="offcanvas-navbar">
            <ul class="offcanvas-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    @if(auth()->check())
                    <a href="{{ route('profiles.get') }}" class="dropdown-hover"><i style="padding-right: 10px;"
                            class="dropdown-hover loggedUser fa fa-user"></i>{{ auth()->user()->first_name . " " . auth()->user()->last_name }}
                    ...
                    @else
                    <a href="/login"><i style="padding-right: 10px;" class="fa fa-user"></i> Најава/
                        Регистрација</a>
                    @endif
                </li>
