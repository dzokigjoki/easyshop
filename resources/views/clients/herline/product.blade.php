...
@section('content')
    ...
    <link rel="stylesheet" href="{{ url_assets('/herline/css/shop.css') }}">
    ...
    <?php
    $productCategories = EasyShop\Models\Product::with('categories')
        ->find($product->id)
        ->categories->pluck('id')
        ->toArray();
    ?>
                        ...
                        <div class="product">
                            <div class="container">
                                <div class="row summary-container">
                                    <div class="row">
                                        <div class="col-lg-12 ">
                                            <h1 class="flex-centered product_title entry-title mb-35">
                                                {{ $product->title }}
                                                @if ($product->sold_out)
                                                    <span style="margin-left: 15px;" class="sold-out-badge-relative">
                                                        Sold Out!
                                                    </span>
                                                @endif
                                            </h1>
                                        ...
                                        <div class="single-product-images">
                                            <div class="single-product-images-slider">
                                                <div class="caroufredsel product-images-slider"
                                                    ...
                                                    data-scrollduration="500" data-height="variable" data-scroll-fx="none"
                                                    data-visible="1" data-circular="1" data-responsive="1">
                                            ...
                                            <div class="single-product-thumbnails">
                                                <div class="caroufredsel product-thumbnails-slider" data-visible-min="2"
                                                    data-visible-max="4" data-scrollduration="500" data-direction="up"
                                                    data-height="100%" data-circular="1" data-responsive="0">
                                                    <div class="caroufredsel-wrap">
                                                        <ul
                                                                        ...
                                                                        <td>
                                                                            <div class="select-option swatch-wrapper selected">
                                                                                <a href="#" title="Extra Large" class="swatch-anchor">
                                                                                    <img src="{{ url_assets('/herline/images/sizes/XL.jpg')}}"
                                                alt="thumbnail" width="35" height="35"/>
                                                </a>
                                            </div>
                                            <div class="select-option swatch-wrapper">
                                                <a href="#" title="Extra Extra Large" class="swatch-anchor">
                                                    <img src="{{ url_assets('/herline/images/sizes/XXL.jpg')}}"
                                                        alt="thumbnail" width="35" height="35" />
                                                </a>
                                            </div>
                                            <div class="select-option swatch-wrapper">
                                                <a href="#" title="Medium" class="swatch-anchor">
                                                    <img src="{{ url_assets('/herline/images/sizes/M.jpg')}}"
                                                        alt="thumbnail" width="35" height="35" />
                                                </a>
                                            </div>
                                            <div class="select-option swatch-wrapper">
                                                <a href="#" title="Small" class="swatch-anchor">
                                                    <img src="{{ url_assets('/herline/images/sizes/S.jpg')}}"
                                                        alt="thumbnail" width="35" height="35" />
                                                </a>
                                            </div>
                                            </td>
                                                    ...
                                                    @if (!$product->sold_out)
                                                        <div class="single_variation_wrap">
                                                            <div class="variations_button">
                                                                <div class="quantity">
                                                                    <input data-product-quantity name="quantity"
                                                                        type="number" class="input-text qty text" value="1"
                                                                        min="1" max="10">
                                                                </div>
                                                                <button class="button" @if (in_array(42, $productCategories))
                                                                    data-bundle="7"
                                                    @endif
                                                    value="{{ $product->id }}" data-add-to-cart="">Додади во
                                                    кошничка</button>
                                                </div>
                                            </div>
                                            @endif
                                            @if (auth()->user())
                                                <button class="button" value="{{ $product->id }}"
                                                    data-add-to-wish-list="">Додади во
                                                    листа на желби</button>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="product_meta">
                                        ...
                                        @if (count($productCategories) > 0)
                                            <span class="posted_in">Категорија: <a
                                                    href="#">{{ $product->categories[0]->title }}</a></span>
                                        @endif
                                        <span class="posted_in">Бренд: <a href="#">Herline</a></span>
                                        <?php $variations = $product->variationValuesAndIds()->groupBy('name'); ?>

                                        <br>
                                        <span><button class="btn_guide" data-toggle="modal" data-target="#modalSizes">
                                                <strong>Водич
                                                    за големини</strong></button></span>
                                        <div class="modal fade" id="modalSizes" tabindex="-1" role="dialog"
                                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Водич за големини
                                                        </h5>
                                                ...
                                                @foreach ($value as $v)
                                                    <label>
                                                        <input data-product-variation type="radio"
                                                            ...
                                                            class="card-input-element variation_{{ $counter }}" />
                                        ...
                                        @if (isset($parentProducts) && !empty($parentProducts) && count($parentProducts) > 0)
                                            ...
                                            @endforeach
                                        @elseif(isset($childrenProducts) && !empty($childrenProducts) &&
                                            count($childrenProducts) >
                                            0)
                                            <h5 class="mt-30">Боја</h5>
