...
<br>
                    ...
                    {{csrf_field()}}
                  <table class="table-responsive table-shopping-cart" style="width: 100%;">
                      <tr>
                          <td>
                              <label for="first_name" class="required">Име</label>
                          </td>
                          <td>
                              <input class="form-control" type="text" required name="first_name" id="first_name" autofocus="" value="{{ old('first_name', $client->first_name) }}" />
        ...
        <!--/ [col]-->
                      ...
                      <tr>
                          ...
                          <td><input class="form-control" type="text" required name="last_name" id="last_name"  value="{{ old('last_name', $client->last_name) }}" />
                      ...
                      <tr>
                          ...
                          <td>
                              <input class="form-control" type="email" disabled readonly name="email" id="email" autofocus="" value="{{ old('email', $client->email) }}" />
                          </td>
                      </tr>
                      <tr>
                          ...
                          <td>  <select class="form-control" id="country_id"  name="country_id" disabled>
                                  @foreach($countries as $country)
                                      <option  @if(isset($client->country_id) && $client->country_id == $country->id) selected @endif value="{{$country->id}}">{{$country->country_name}}</option>
                                  @endforeach
                      ...
                      <tr>
                          ...
                          <td>   <input class="form-control" type="text" name="address" id="address" required=""  value="{{ old('address', $client->address) }}" />

                              @if($errors->has('address'))<div class="error">Полето Адреса е задолжително</div>@endif</td>
                      </tr>
                      <tr>
                          <td> <label for="phone">Пол</label></td>
                          <td> <input  type="radio" @if($client->gender == 'male') checked="checked" @endif value="male" name="gender" id="radio_1">
                      ...
                      <tr>
                          ...
                          <td> <select class="form-control" id="city_id"  name="city_id" >
                                  ...
                                  @foreach($cities as $city)
                                      <option  @if(isset($client->city_id) && $client->city_id == $city->id) selected @endif value="{{$city->id}}">{{$city->city_name}}</option>
                                  @endforeach
                              </select></td>
                      </tr>
                      <tr>
                          <td><label for="phone" class="required">Телефон</label></td>
                          <td><input class="form-control" type="text" name="phone" id="phone" required="" value="{{ old('phone', $client->phone) }}" />
