                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="entry-content">
                                <h2 class="special-heading">Најави се</h2>
                                <form class="woocommerce-form-login js-contact-form" action="{{route('auth.login.post')}}" method="POST">
                                {{csrf_field()}}
                                    <p class="woocommerce-form-row">
                                        <input type="email" class="woocommerce-Input input-text" name="email" id="email" value="" placeholder="Е-пошта *">
                                    </p>
                                    <p class="woocommerce-form-row">
                                    ...
                                    <p class="form-button">
                                        <label>
                                            <input type="submit" class="woocommerce-Button au-btn btn-small" name="login" value="Најава">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="novas-form-signup">
                                ...
                                {{csrf_field()}}
                                    ...
                                    <p class="woocommerce-form-row">
                                        <input class="woocommerce-Input input-text" type="password" name="password" id="password" value="" placeholder="Лозинка *">
                                    </p>
                                    <p class="woocommerce-form-row">
                                    ...
                                    <p class="form-button">
                                        <input type="submit" class="woocommerce-Button au-btn btn-small" name="register" value="Регистрирај се">
                                        <span class="arrow-right"><i class="zmdi zmdi-arrow-right login_arrow"></i></span>
                                    </p>
                                </form>
                            </div>
                        </div>
