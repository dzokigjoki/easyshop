        ...
        <div class="row">
            <div class="col-lg-3">
                <ul class="nav myaccount-tab-trigger" id="account-page-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="account-orders-tab" data-toggle="tab" href="#account-wishlist" role="tab" aria-controls="account-orders" aria-selected="false">Желби</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
                                ...
                                <div class="quicky-form-inner">
                                    ...
                                    <div class="single-input single-input-half">
                                        ...
                                        <div class="@if($errors->has('email')) has-error  @endif">
                                            <input disabled="" name="email" type="email" class="border-radius-none form-control" placeholder="Е-пошта" value="{{ old('email', $client->email) }}">
                                        </div>
                                    </div>
                                    <div class="single-input single-input-half">
                                    ...
                                    <div class="single-input single-input-half">
                                        ...
                                        <input type="text" name="phone" placeholder="Телефон" value="{{ old('phone', $client->phone) }}">
                                    </div>
                                    <div class="single-input single-input-half">
                                    ...
                                    <div class="single-input single-input-half">
                                        ...
                                        <div class="@if($errors->has('address')) has-error  @endif">
                                            <input type="text" class="border-radius-none form-control" placeholder="Адреса за плаќање" name="address" value="{{ old('address', $client->address) }}">
                                        </div>
                                    </div>
                                    <div class="single-input single-input-half">
                                        <label>Град:</label>
                                        <div>
                                            <select style="width: 100%" id="city_id" class="border-radius-none form-control" name="city_id">

                                                @foreach($cities as $city)
                                                <option @if(isset($client->city_id))
                                                    @if($client->city_id==$city->id)
                                                    selected
                                                    @endif
                                                    @else

                                                    @if($city->city_name=="Скопје")
                                                    selected
                                                    @endif
                                                    @endif
                                                    value="{{$city->id}}"
                                    ...
                                    <div class="single-input single-input-half">
                                        ...
                                        <div class="@if($errors->has('address_shiping')) has-error  @endif">
                                            <input type="text" class="border-radius-none form-control" placeholder="Адреса за испорака" name="address_shiping" value="{{ old('address_shiping', $client->address_shiping) }}">
                                        </div>
                                    </div>
                                    <div class="single-input single-input-half">
                                        <label>Град:</label>
                                        <div>
                                            ...
                                            <select id="city_id_shipping" class="border-radius-none form-control" style="width:100%;" name="city_id_shipping">
                                                @foreach($cities as $city)
                                                <option @if(isset($client->city_id_shipping))
                                                    @if($client->city_id_shipping==$city->id)
                                                    selected
                                                    @endif
                                                    @else
                                                    @if($city->city_name=="Скопје")
                                    ...
                                    <div class="single-input w-100 pt-2">
                                        <button class="au-btn btn-small " type="submit">Зачувај</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="tab-pane fade" id="account-wishlist" role="tabpanel" aria-labelledby="account-wishlist-tab">
                        <div class="myaccount-wishlist">
                            ...
                            <table style="width: 100%" class="shop_table cart wishlist_table_nr" data-pagination="no" data-per-page="5" data-page="1" data-id="" data-token="">
                                <tbody>
                                    ...
                                    <tr wish-list-row="{{$wi->id}}">
                                        ...
                                        <td class="product-price">
                                            ...
                                            <span class="price-product">
                                                <span class="discounted-price">
                                                    <strong>{{number_format($wi->price_discount, 0, ',', '.')}}
                                                        МКД</strong>
                                                </span>
                                                <del class="old-price">
                                                    {{number_format($wi->price, 0, ',', '.')}} МКД
                                                </del>
                                            </span>
                                            @else
                                            <span class="woocommerce-Price-amount amount price-product"><strong>{{number_format($wi->price, 0, ',', '.')}}
                                                    МКД</strong></span>
                                            @endif
                                        </td>
                                        <td class="product-add-to-cart">
                                            <!-- Date added -->
                                            <!-- Add to cart button -->
                                            <a href="" rel="nofollow" data-add-to-cart value="{{$wi->id}}" data-product_sku="" data-quantity="1" class="button product_added add_to_cart_button product_type_simple add_to_cart button alt"> Додади во кошничка</a>
                                            <!-- Change wishlist -->
