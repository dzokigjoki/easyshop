...
@section('content')
    ...
    <link rel="stylesheet" href="{{ url_assets('/mymoda/plugins/slick-new/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ url_assets('/mymoda/plugins/slick-new/slick/slick-theme.css') }}">
                    ...
                    <div class="row row-1 justify-content-center row-padding-20">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-12 padding-20">
                            <div class="banner-item text-box-overlay bottom-center">
                                <div class="image">
                                    <a href="/c/26/office-izgled">
                                        <span class="image-lazysize" style="position:relative;padding-top:162.1621622%;">
                                            

                                        <img src="{{ url_assets('/mymoda/images/1.jpg') }}" alt="">
                                        </span>
                                    </a>
                                </div>
                                <div class="text text-center bg-color-none pob-10  fix-btn-below" style="background: ;">
                                    <div class="subtitle bold-text big-size" style="color: #ffffff; font-size: 50px;">OFFICE
                                        <br>ИЗГЛЕД</div>
                                    <a class="bold-text btn btn-banner" href="/c/26/office-izgled"
                                        style="color: #000000; background: #ffffff; font-size: 16px;">ПОГЛЕДНИ</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-12 padding-20">
                            ...
                            <div class="banner-item text-box-overlay bottom-left">
                                <div class="image">
                                    <a href="/c/21/farmerki">
                                        <span class="image-lazysize"
                                            style="position:relative;padding-top:78.94736842105263%;">
                                            
                                            

                                            <img src="{{ url_assets('/mymoda/images/2.jpg') }}" alt="">
                                        </span>
                                    </a>
                                </div>
                                ...
                                <div class="image">
                                    <a href="/c/1/bluzi">
                                        ...
                                        <span class="image-lazysize"
                                            ...
                                            <img src="{{ url_assets('/mymoda/images/3.jpg') }}" alt="">
                                        </span>
                                ...
                                <div class="image">
                                    <a href="/c/7/koshuli">
                                        ...
                                        <span class="image-lazysize" style="position:relative;padding-top:162.1621622%;">
                                            ...
                                            <img src="{{ url_assets('/mymoda/images/4.jpg') }}" alt="">
                                        </span>
                                            ...
                                            <div class="ps-product__thumbnail product-image">
                                                <a href="/p/{{ $product->id }}/{{ $product->url }}"
                                                    ...
                                                    @if (\EasyShop\Models\Product::hasDiscount($product->discount))
                                                        <?php
                                                        $discount = EasyShop\Models\Product::getPriceRetail1($product,
                                                        false, 0);
                                                        if ($product->price != 0) {
        ...
        <div class="container-fluid">
            ...
            <div class="widget-image">
                <div class="banner-item text-box-overlay center-left">
                    ...
                    <div class="image">
                        <a href="https://apps.apple.com/us/app/moda-mk/id1548200214">

                            <span class="image-lazysize">
                                <!-- noscript pattern -->


                                <img src="{{ url_assets('/mymoda/images/banner_for_mob.jpg') }}" alt="">
                            </span>
                    ...
                    <div class="text text7">
                        ...
                        <div class="title bold-text" style="color: #000000; font-size: 29px;">Купувајте едноставно од вашите
                            мобилни уреди</div>



                        <div class="subtitle bold-text" style="color: #000000; font-size: 37px;">со новата MODA.mk
                            апликација</div>
...
@section('scripts')
    ...
    <script src="{{ url_assets('/mymoda/plugins/slick-new/slick/slick.min.js') }}"></script>
    <script type="text/javascript" src="//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script>
    <script>
