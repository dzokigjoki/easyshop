            ...
            <h4 class="color-black">Шифра: {{$product->unit_code}}</h4>
                    ...
                    <div class="row">
                        ...
                        <a href="tel:+38971683682" class="col-lg-4 col-md-4 col-sm-4 col-xs-6" id="phone"><img
                                src="{{ url_assets('/mymoda/images/icons/phone.png') }}" class="icon-img" alt=""> Нарачај
                            преку
                            телефон</a>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <p><br>Откако курирската служба ќе ви ја достави пратката, ве молиме проверете го
                                        ...
                                        <strong>info@mymoda.mk</strong> при што ќе ги наведете причините поради кои сакате
                                        да
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <div class="ps-site-info Box">
                                            ...
                                            <p class="text-justify black-color p-xs-10" style="margin-bottom: 10px;">
                                                Само во Mymoda можете да најдете најмодерна и најквалитетна женска
                                                облека.
                                                Бидете во тренд и
                                                купувајте
