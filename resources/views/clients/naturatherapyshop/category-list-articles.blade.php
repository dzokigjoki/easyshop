            ...
            <div class="row">
                <aside class="col-lg-3 sidebar left-sidebar">
                    <div class="widget pt-10 pb-10 filter-by-price clearfix">
                        <h4 class="bottom-line filter_heading pb-30 pb-sml-0 full-grey">Цена</h4>
                        <div data-price-slider="" id="slider-range"></div>
                    </div>
                    @if (count($filters))
                    <h4 class="bottom-line filter_heading pb-30 pt-30 pb-sml-10 full-grey">Филтри</h4>
                ...
                <div class="col-lg-9 pt-sml-20 catalogue-colmb-50">
                    <div class="shop-catalogue grid-view">
                        <div data-products-list="" class="row items-grid">
                            @include('clients.naturatherapyshop.partials.category-products-list')
                        </div>
                    </div>
                </div>
            </div>
