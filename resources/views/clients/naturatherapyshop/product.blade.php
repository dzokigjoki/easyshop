                    ...
                    <div class="col-md-7 col-xs-12 product-description-wrap">
                        ...
                        <div class="product-actions">
                            ...
                            <a href="#" value="{{ $product->id }}" data-add-to-cart=""
                                class="btn btn-dark btn-lg add-to-cart"><span>Додади во кошничка</span></a>
                        ...
                        <div class="product_meta">
                            ...
                            @if (isset($categories_for_product))
                                @foreach ($categories_for_product as $productCategory)
                                    ...
                                    <span class="brand_as">Категории:{{ $productCategory->$title }}</span>
                                @endforeach
                            @endif
                        </div>
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <a data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo"
                                            class="plus collapsed">Декларација<span>&nbsp;</span>
                                        </a>
                                    </div>
