...
@section('content')
    ...
    <style id='marra-style-inline-css' type='text/css'>
        ...
        .elementor-434 .elementor-element.elementor-element-a2dc938>.elementor-column-wrap>.elementor-motion-effects-container>.elementor-motion-effects-layer {
            background-image: url({{ url_assets('/naturatherapyshop/img/2.jpg') }});
        ...
        @media(max-width:767px) {
            ...
            .elementor-434 .elementor-element.elementor-element-a2dc938:not(.elementor-motion-effects-element-type-background)>.elementor-column-wrap,
            .elementor-434 .elementor-element.elementor-element-a2dc938>.elementor-column-wrap>.elementor-motion-effects-container>.elementor-motion-effects-layer {
                background-image: url({{ url_assets('/naturatherapyshop/img/2.jpg') }}) !important;
                background-size: cover;
                                    ...
                                    <section
                                        ...
                                        <div class="elementor-container elementor-column-gap-default">
                                            <div class="elementor-row">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="qodef-m-image-holder">
                                                                            ...
                                                                            <div class="qodef-m-image">
                                                                                <img width="1100" height="1106" @if (!empty(\BannerHelper::getBannerByCategory('promotions')))
                                                                                ...
                                                                                @if (!empty(\BannerHelper::getBannerByCategory('promotions')))
                                                                                    srcset="{{ '/uploads/banners/' . \BannerHelper::getBannerByCategory('promotions')[0]->id . '/md_' . \BannerHelper::getBannerByCategory('promotions')[0]->image }}
                                                                                    1100w,
                                                                                    {{ '/uploads/banners/' . \BannerHelper::getBannerByCategory('promotions')[0]->id . '/md_' . \BannerHelper::getBannerByCategory('promotions')[0]->image }}
                                                                                    768w"
                                                                                @endif
                                                                        ...
                                                                        <div class="qodef-m-content">
                                                                            ...
                                                                            transform: translateX(-50%);"
                                                                                    ...
                                                                                    {!! trans('naturatherapy/global.view_all_promotions') !!}
                                                                                    <div style="margin: auto"
                                                                                        ...
                                                                                        <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined qodef-size--small qodef-html--link"
                                                                                            href="{{\BannerHelper::getBannerByCategory('promotions')[0]->url}}"
                                                                                            target="_self"
                                                                                            style="background:rgba(85, 129, 130, 0.5)">
                                                                                            <span style="color: black"
                                                                                                class="qodef-m-text">{!! trans('naturatherapy/global.view_more') !!}</span>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                ...
                                                {{-- <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-a2dc938"
                                                    data-id="a2dc938" data-element_type="column"
                                                    data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                    <div
                                                        class="elementor-column-wrap elementor-element-populated width_120_mobilen">
                                                        <div class="elementor-widget-wrap">
                                                            <section style="padding: 0;"
                                                                class="elementor-section elementor-inner-section elementor-element elementor-element-435fcbe elementor-section-full_width elementor-section-content-middle elementor-section-height-default elementor-section-height-default qodef-elementor-content-no"
                                                                data-id="435fcbe" data-element_type="section">
                                                                <div
                                                                    class="elementor-container elementor-column-gap-default">
                                                                    <div class="elementor-row">
                                                                        <div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-57ffd99"
                                                                            data-id="57ffd99" data-element_type="column">
                                                                            <div
                                                                                class="elementor-column-wrap elementor-element-populated">
                                                                                <div style="justify-content: center;"
                                                                                    class="elementor-widget-wrap">

                                                                                    <div class="elementor-element elementor-element-3b4bf19 elementor-widget elementor-widget-spacer"
                                                                                        data-id="3b4bf19"
                                                                                    ...
                                                                                    <div class="elementor-element elementor-element-d4f5689 elementor-widget__width-auto elementor-widget elementor-widget-marra_core_button"
                                                                                        data-id="d4f5689"
                                                                                        data-element_type="widget"
                                                                                        data-widget_type="marra_core_button.default">
                                                                                        <div
                                                                                            class="elementor-widget-container">
                                                                                            <a style="background: #558182;"
                                                                                                class="qodef-shortcode qodef-m text_smaller_mob qodef-button qodef-layout--outlined qodef-size--small qodef-html--link"
                                                                                                href="{{ $urlLang }}c/3/produkte"
                                                                                                target="_self">
                                                                                                <span
                                                                                                    style="background: #558182; color: white"
                                                                                                    class="qodef-m-text">{!! trans('naturatherapy/global.all_products') !!}
                                                                                                </span>
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                        ...
                                                        <div class="qodef-m-content-inner">
                                                            <div style="position: absolute; top: 40%; 
                                                                ...
                                                                <div style="margin: auto"
                                                                    class="qodef-m-button">
                                                                     <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined qodef-size--small qodef-html--link"
                                                                        href="{{\BannerHelper::getBannerByCategory('big-slider')[0]->url}}" style="background:rgba(85, 129, 130, 0.5)">
                                                                        <span style="color: black" class="qodef-m-text">
                                                                            @if (\BannerHelper::getBannerByCategory('big-slider')[0]->short_description == null) {!! trans('naturatherapy/global.view_more') !!} @else {{\BannerHelper::getBannerByCategory('big-slider')[0]->short_description}}
                                                                            @endif
                                                                        </span>
                                                                    </a>
                                                                </div>
                                            ...
                                            <div class="col-sm-4 col-xs-12">
                                                <div style="margin-bottom: 2%">
                                                    ...
                                                    @if ($banner->url != null)
                                                        <div class="qodef-m-content">
                                                            <div class="qodef-m-content-inner">
                                                                <div style="position: absolute; top: 40%; left: 50%; transform: translateX(-50%); background:rgba(85, 129, 130, 0.5)"
                                                                    class="qodef-m-content-box">
                                                                    <div style="margin: auto" class="qodef-m-button">
                                                                        <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined qodef-size--small qodef-html--link"
                                                                            href="{{ $banner->url }}" target="_self">
                                                                            <span style="color:black"
                                                                                class="qodef-m-text">@if ($banner->short_description == null) {!! trans('naturatherapy/global.view_more') !!} @else {{ $banner->short_description }}@endif</span></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="elementor-widget-container">
                                                                    <div
                                                                        ...
                                                                        <div class="qodef-m-content">
                                                                            ...
                                                                            transform: translateX(-50%);"
                                                                                    class="qodef-m-content-box">
                                                                                    {!! trans('naturatherapy/global.for_all_men') !!}
                                                                                    <div style="margin: auto"
                                                                                        class="qodef-m-button">
                                                                                        <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined qodef-size--small qodef-html--link"
                                                                                            href="{{ $urlLang }}p/48/prostatol-complex-30-kapsula"
                                                                                            target="_self">
                                                                ...
                                                                <div class="elementor-widget-container">
                                                                    <div class="elementor-spacer">
                                                                        <div class="elementor-spacer-inner">
                                                                            <div class="qodef-m-content">
                                                                                <div class="qodef-m-content-inner"
                                                                                    style="padding: 10% 0% 4% 13.5%">
                                                                                    <div class="qodef-m-content-box">
                                                                                        {!! trans('naturatherapy/global.health_of_nature') !!}
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="elementor-widget-container">
                                                                    <div
                                                                        ...
                                                                        <div class="qodef-m-image-holder">
                                                                            <div class="qodef-m-image">
                                                                                <img width="1100" height="1106"
                                                                                    ...
                                                                                    class="attachment-full size-full"
                                                                                    alt="a" loading="lazy"
                                                                                    srcset="{{ url_assets('/naturatherapyshop/img/our_shops_gallery/2.jpg') }} 1100w, {{ url_assets('/naturatherapyshop/img/our_shops_gallery/2.jpg') }} 298w, {{ url_assets('/naturatherapyshop/img/our_shops_gallery/2.jpg') }} 1018w, {{ url_assets('/naturatherapyshop/img/5.jpg') }} 150w, {{ url_assets('/naturatherapyshop/img/our_shops_gallery/2.jpg') }} 768w, {{ url_assets('/naturatherapyshop/img/5.jpg') }} 600w, {{ url_assets('/naturatherapyshop/img/5.jpg') }} 800w, {{ url_assets('/naturatherapyshop/img/5.jpg') }} 100w"
                                                                                    sizes="(max-width: 1100px) 100vw, 1100px" />
                                                                            </div>
                                                                            <div class="qodef-m-overlay">
                                                                            </div>
                                                                        ...
                                                                        <div class="qodef-m-content">
                                                                            ...
                                                                            transform: translateX(-50%);"
                                                                                    class="qodef-m-content-box">
                                                                                    {!! trans('naturatherapy/global.look_at') !!}
                                                                                    <div style="margin: auto"
                                                                                        class="qodef-m-button">
                                                                                        <a class="qodef-shortcode qodef-m  qodef-button qodef-layout--outlined-white qodef-size--small qodef-html--link"
                                                                                            href="{{ $urlLang }}our-shops "
                                                                                            target="_self"> <span
                                                                                                style="color:white;"
                                                                                                class="qodef-m-text">{!! trans('naturatherapy/global.our_shops') !!}</span></a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <span class="qodef-e qodef-grid-item">
                                                                                <span class="qodef-e-inner">
                                                                                    <span class="qodef-e-image">
                                                                                        <a itemprop="url"
                                                                                            href="{{ $urlLang }}p/61/aloe-royal"
                                                                                            target="_self">
                                                                                            <span class="qodef-e-logo">
                                                                                                <img width="325" height="87"
                                                                                                    src="{{ url_assets('/naturatherapyshop/img/brands/02_al.png') }}"
                                                                                                    class="attachment-full size-full"
                                                                                                    alt="a" loading="lazy"
                                                                                                    srcset="{{ url_assets('/naturatherapyshop/img/brands/02_al.png') }} 325w, {{ url_assets('/naturatherapyshop/img/brands/02_al.png') }} 300w"
                                                                                                    sizes="(max-width: 325px) 100vw, 325px" />
                                                                                            </span>
                                                                                            <span
                                                                                                class="qodef-e-hover-logo">
                                                                            ...
                                                                            <span class="qodef-e qodef-grid-item">
                                                                                <span class="qodef-e-inner">
                                                                                    <span class="qodef-e-image">
                                                                                        <a itemprop="url"
                                                                                            href="{{ $urlLang }}p/7/snail-complex-30-kapsula"
                                                                                            target="_self">
                                                                                            <span class="qodef-e-logo">
                                                                                                <img width="325" height="87"
                                                                            ...
                                                                            <span class="qodef-e qodef-grid-item">
                                                                                <span class="qodef-e-inner">
                                                                                    <span class="qodef-e-image">
                                                                                        <a itemprop="url"
                                                                                            href="{{ $urlLang }}p/73/liquid-chlorophyll"
                                                                                            target="_self">
                                                                                            <span class="qodef-e-logo">
                                                                                                <img width="325" height="87"
                                                                            ...
                                                                            <span class="qodef-e qodef-grid-item">
                                                                                <span class="qodef-e-inner">
                                                                                    <span class="qodef-e-image">
                                                                                        <a itemprop="url"
                                                                                            href="{{ $urlLang }}p/30/gastro-complex-250ml-21-falas"
                                                                                            target="_self">
                                                                                            <span class="qodef-e-logo">
                                                                                                <img width="325" height="87"
                                                                                        ...
                                                                                        class="qodef-woo-product-mark qodef-woo-onsale">Sale</span> --}}
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <a href="{{ $urlLang }}p/{{ $product->id }}/{{ $product->url }}"
                                                                                                    ...
                                                                                                    rel="nofollow">{!! trans('naturatherapy/global.look_more') !!}</a>
                                                                                                <a value="{{ $product->id }}"
                                                                                                    data-add-to-cart
                                                                                                    style="padding: 5px 15px; margin-top: 5px;"
                                                                                                    class="button product_type_simple add_to_cart_button ajax_add_to_cart"
                                                                                                    rel="nofollow">{!! trans('naturatherapy/global.add_basket') !!}</a>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div
                                                                                            ...
                                                                                            <h5 itemprop="name"
                                                                                                ...
                                                                                                <a itemprop="url"
                                                                                                    ...
                                                                                                    href="{{ $urlLang }}p/{{ $product->id }}/{{ $product->url }}">
                                                                                                    {{ $product->title }}</a>
                                                                                            </h5>
                                                                                            <?php $discount = EasyShop\Models\Product::getPriceRetail1($product, true, 2); ?>
                                                                                            ...
                                                                                            @else
                                                                                                <span
                                                                                                    class="woocommerce-Price-amount amount">{{ number_format($product->price, 2, ',', '.') }}
                                                                                                    @if ($price_multiplier == 1)
                                                                                                    &#128; @else LEK
                                                                                                    @endif
                                                                                                </span>
        ...
        <div id="modal" style="padding-right: 0 !important;" class="modal fade" tabindex="-1" role="basic"
            ...
            <div>
                <div style="background: #558182;" class="modal-header">
                    ...
                    <h4 id="beforeSpinHeading" class="white text-center modal-title bold">Blini një paketë produktesh dhe
                        <strong class="white">
                            fitoi</strong>
                        shpërblime të vlefshme
                    </h4>
                    <h4 id="afterSpinHeading" class="white modal-title bold">Urime! Ju fituat <strong id="discountValue"
                            class="white"></strong></h4>
                </div>
                <div class="modal-body">
                    <div class="row form-group">
                        <img class="modal_img_width" src="{{ url_assets('/naturatherapyshop/img/promotion.jpg') }}"
                            alt="">
                    </div>
                </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <div id="beforeSpinContent">
                                <div class="white">
                                    Vendosni një email adresë të vlefshme për të rrotulluar rrotën!
                                </div>
    ...
    {{-- <div id="infoModalGames" style="padding-right: 0 !important;" class="modal fade" tabindex="-1" role="basic"
        ...
        <div>
            <div class="modal-header">
                <button type="button" class="close" style=" color: white; font-size: 17px;" data-dismiss="modal"
                    aria-hidden="true">X</button>
                <h4 class="white modal-title bold">Rregullat për pjesëmarrjen në lojën shpërblyese </h4>
            </div>
            <div class="modal-body">
                <div class="row form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="beforeSpinContent">
                                ...
                                <div class="white">
                                    <strong class="white">Правила</strong>
                                    <ul>
                                        <li>- Rrota përmban zbritje prej 5% deri 40%</li>
                                        <li>- Ju lutemi vendosni email adresën!</li>
                                        <li>- Kodi zgjat 7 ditë</li>
                                        <li>- Për produktet që janë tashmë në zbritje - zbritja nga kodi nuk llogaritet
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div id="afterSpinContent">
                                <h5 class="white">
                                    *Klikoni tek kodi për ta kopjuar sepse nëse e fikni modalin, ai kod do të humbasë!
                                </h5>
                                <br>
                                <div class="white">
                                    Ky është kodi juaj që zgjat 7 ditë dhe duhet të futet gjatë bërjes së porosisë. Vlen vetëm për një përdorim në të gjithë shportën.
                                </div>
                                <br>
                                <label class="form-control" name="promo_code" id="promo_code" type="promo_code"
                                    placeholder="Промотивен код*" onclick="myFunction(this)"></label>
