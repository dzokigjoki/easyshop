                ...
                <div class="col-md-12">
                    ...
                    <ul>
                        <li>
                            ...
                            {!! trans('naturatherapy/global.street_1') !!}
                        </li>
                    </ul>
                    <h5>{!! trans('naturatherapy/global.street_2') !!}
                        </li>
                    </h5>
                    <ul>
                        <li>
                            {!! trans('naturatherapy/global.street_3') !!}

                        </li>
                        <li>
                            {!! trans('naturatherapy/global.street_4') !!}

                        </li>
                        <li>
                            {!! trans('naturatherapy/global.street_5') !!}
