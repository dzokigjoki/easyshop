                ...
                <div class="col-md-4 col-xs-12 col-xxs-12">
                    <div class="widget footer-links">
                        ...
                        <ul class="list-no-dividers li_footer">
                            <li><a><i class="fa fa-map-marker"></i> {!! trans('naturatherapy/global.street_number') !!}</a></li>
                            <li><a href="mailto:contact@naturaks.com"><i class="fa fa-envelope"></i>
                               @if (App::getLocale() != 'al') contact@naturatherapy.mk @else contact@naturaks.com  @endif</a></li>
                               @if (App::getLocale() != 'al')
                            <li><a href="tel:+389 71317111"><i class="fa fa-phone"></i> +389 71 317 111</a></li>
                            @else
                            <li><a href="tel:0038945 956 000"><i class="fa fa-phone"></i> +383 45 956 000</a></li>
                            @endif
