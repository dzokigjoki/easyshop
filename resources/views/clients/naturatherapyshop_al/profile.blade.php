                        ...
                        <tbody>
                            ...
                            <tr wish-list-row="{{$wi->id}}">
                                ...
                                <td class="product-price text-center price">
                                    ...
                                    ?>
                                    <del>
                                        <span>{{number_format($wi->price, 0, ',', '.')}} @if($price_multiplier == 1) &#128; @else LEK  @endif</span>
                                    </del>
                                    <ins>
                                    ...
                                    @else
                                    <ins>
                                        <span class="amount">{{number_format($wi->price, 0, ',', '.')}} @if($price_multiplier == 1) &#128; @else LEK  @endif</span>
                                    </ins>
                                    @endif
                                </td>
