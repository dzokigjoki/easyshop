                ...
                <div class="row">
                    ...
                    <aside class="col-md-3 sidebar">
                        ...
                        <div class="widget recent-posts">
                            <h3 class="widget-title heading relative bottom-line full-grey">
                                {!! trans('naturatherapy/global.newest_post') !!}</h3>
                                    ...
                                    @foreach ($related as $newblog)
                                        <li class="entry-li">
                                            <article class="post-small clearfix">
                                                <div class="entry-img">
                                                    <a href="{{ $urlLang }}b/{{ $newblog->id }}/{{ $newblog->url }}">
                                                        <img src="/uploads/posts/{{ $blog->id }}/sm_{{ $newblog->image }}"
                                                            alt="">
                                                    </a>
                                                </div>
                                                <div class="entry">
                                                    <h3 class="entry-title"><a
                                                            href="{{ $urlLang }}b/{{ $newblog->id }}/{{ $newblog->url }}">{{ $newblog->title }}</a>
                                                    </h3>
                        ...
                        <div class="widget tags light clearfix">
                            <h3 class="widget-title heading relative bottom-line full-grey">
                                {!! trans('naturatherapy/global.view_more') !!}</h3>
