                                                ...
                                                <span class="amount">
                                                    @if (\EasyShop\Models\Product::hasDiscount($product->discount))
                                                        ...
                                                        <del style="color: #C9302C">
                                                            {{ number_format($product->price_retail_1, 3, ',', '.') }} LEK

                                                        </del><br>
                                                        {{ $discount }}
                                                    @else
                                                        {{ number_format($product->cena, 3, ',', '.') }} LEK
                                            ...
                                            <td class="text-center product-subtotal">
                                                <span class="amount">
                                                    @if (\EasyShop\Models\Product::hasDiscount($product->discount))
                                                        ...
                                                        $discount = EasyShop\Models\Product::getPriceRetail1($product, true, 0);
                                                        ?>
                                                        {{ $product->quantity * $discount }} LEK
                                                    @else
                                                        {{ $product->quantity * $product->cena }} LEK
                                        ...
                                        <tbody>
                                            <tr class="cart-subtotal">
                                                ...
                                                <td style="text-align: center !important">
                                                    <span class="amount">{{ $totalPrice }} LEK
                                            ...
                                            <tr class="shipping">
                                                ...
                                                <td style="text-align: center !important">
                                                    <span id="deliveryPrice">{{ number_format($cargoPrice, 0, ',', '.') }} LEK
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr class="order-total">
                                                ...
                                                <td style="text-align: center !important">
                                                    <strong><span id="priceWithDelivery" class="amount">{{ $priceWithDelivery }} LEK
                                                        </span></strong>
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <form data-form="" id="checkoutForm" method="POST" name="checkout"
                                ...
                                <div class="col-md-8" id="customer_details">
                                    <div>
                                        ...
                                        <p
                                            class="city_other form-row form-row-wide address-field validate-required ecommerce-invalid ecommerce-invalid-required-field">
                                            <label for="city_other">Qytet tjetër
                                                <abbr class="required"
                                                    style="text-decoration: none; border-bottom: none;"
                                                    title="Задолжително">*</abbr>
                                            </label>
                                            <input class="input-text" type="text"
                                                id="city_other" name="city_other" placeholder="{!! trans('naturatherapy/global.address') !!}"
                                                required />
                                        </p>
                                        <p
            ...
            $("#City").change(function(){
                ...
                if($("#City").val() == 37){
                    <?php
                        ...
                        $priceWithDelivery = $totalPrice +$cargoPrice;
                    ?>
                    $("#priceWithDelivery").text({{$priceWithDelivery}} + " LEK");
                    $("#deliveryPrice").text({{number_format($cargoPrice, 0, ',', '.') }} + " LEK");
                }
            });
