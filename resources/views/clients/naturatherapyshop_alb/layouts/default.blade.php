        ...
        <div class="alerto alert-secondary mb-0 d-flex align-items-center" role="alert">
            <div class="row">
                <div class="col-sm-12 cookieInfo">
                    <span class="mr-auto">Web faqja e Natura Therapy përdor cookie për të siguruar që ju të përfitoni përvojën më të mirë nga faqja jonë. Lexoni politikën tonë të cookie-ve në <a href="/politika-e-privatesise" class="alert-link cookieLink">linkun</a>.</span> e mëposhtëm.
                </div>
                <div class="col-sm-12 button-cookie">
                    <button id="btnAcceptCookiePolicy" data-dismiss="alert"
                        type="button" aria-label="Close">Jam dakord</button>
                    <button id="btnDeclineCookiePolicy" data-dismiss="alert"
                        type="button" aria-label="Close">Nuk jam dakort</button>
                </div>
            </div>
        </div>
    </div>
    <main class="main-wrapper">
        @include('clients.naturatherapyshop_alb.partials.header')
        @yield('content')
        <div id="back-to-top">
            <a href="#top"><i class="fa fa-angle-up"></i></a>
        </div>
        @include('clients.naturatherapyshop_alb.partials.footer')
    </main>
