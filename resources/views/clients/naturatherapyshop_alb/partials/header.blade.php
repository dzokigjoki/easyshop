            ...
            <div class="search-cell">
                <form method="get" action="search">
                    <div class="search-field-holder">
                        <input type="search" name="search" class="form-control main-search-input" placeholder="Kërko ...">
                    ...
                    <div class="nav-wrap flex-child">
                        <div class="collapse navbar-collapse text-center" id="navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li class="dropdown">
                                    <a href="{{ $urlLang }}c/3/all-products" class="dropdown-title">
                        ...
                        <ul>
                                ...
                                @if (!Auth()->check())
                                    ...
                                    <div id="profileSection" class="profile-section-container">
                                        ...
                                        <div class="row row_profile">
                                            ...
                                            <div class="col-sm-6">
                                                <a href="{{ $urlLang }}register4">{!! trans('naturatherapy/global.register') !!}</a>
                                            </div>
                                        </div>
                                    </div>
                                @else
                            ...
                            <li class="nav-cart">
                                ...
                                <div id="shoppingCart" class="nav-cart-container">
                                    @include('clients.naturatherapyshop_alb.cart-partial')
                                </div>
                            </li>
                        </ul>
                    </div>
