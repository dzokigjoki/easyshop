<div class="product-item clearfix" style="opacity: 1;">
    ...
    <div class="product-description">
        ...
        <span class="price d-flex">
            ...
            ?>
            <del>
                <span>{{number_format($product->price, 0, ',', '.')}} LEK</span>
            </del>
            <ins>
                <span style="margin-left: 10px;" class="amount">{{$discount}} LEK</span>
            </ins>
            @else
            <ins>
                <span class="amount">{{number_format($product->price, 0, ',', '.')}} LEK</span>
            </ins>
            @endif
        </span>
        <div class="clear"></div>
