...
{{--                                {{dd($cargoPrice)}}--}}
                            ...
                            @foreach($products as $product)
                                ...
                                <?php $priceWithDelivery = $totalPrice >= 3000 ? $totalPrice : $totalPrice + $cargoPrice; ?>
                                    <?php $delivery = $totalPrice >= 3000 ? 0 : $cargoPrice; ?>
                                @endforeach
                                    ...
                                    <table id="cart_table">
                                        ...
                                        <tr>
                                            ...
                                            @foreach(\EasyShop\Models\AdminSettings::getField('paymentMethods') as $i)
                                                <input style="padding-left: 10px;" type="radio" checked="checked" name="paymentType"
                                                       value="{{$i['name']}}"
                            ...
                            <tr>
                                <td class="order-btn-cell" style="padding: 30px 0;">
                                    <button data-pay-button="" style="background-color: #D4362A;" type="submit" class="">Нарачај</button>
                                </td>
                            </tr>
                            <!--/ .contactform -->
                    ...
                    <div class="col-md-8 col-sm-12" id="vkupno_cena">
                            ...
                            <table class="table" id="summary_table">
                                ...
                                @if($totalWeight)
                                    <tr class="table-footer">
                                        ...
                                        <td colspan="3" class="bold"><label>Вкупно маса на пелети</label></td>
                                        <td colspan="2"
                                            class="total align_right"><label class="table_summary">{{ $totalWeight }} kg</label>
                                        </td>
                        ...
                        <p class="cart-text-bottom red-text">* Минимум нарачка за бесплатна испорака е 15 вреќи. Цената за испорака на помали нарачки изнесува дополнителни 1000 денари.</p>
                        <p class="cart-text-bottom">* Цените се по единица мерка "една вреќа" и секоја вреќа е со нето тежина 15кг.</p>
                        <p class="cart-text-bottom">* Следствено на тоа и плаќањето се одвива по количина на вреќи.</p>
                        <p class="cart-text-bottom">* Во секоја кошничка стои колку вреќи имате нарачано, но и колку е тоа вкупно во килограми.</p>
