...
<div class="page_wrapper">
        <div class="container">
            ...
            <!-- - - - - - - - - - - - - - Breadcrumbs - - - - - - - - - - - - - - - - -->
            <br>
            <ul style="margin-top: -30px; margin-bottom: 0px !important;" class="breadcrumb">
                            ...
                            <div class="post has-post-thumbnail">
                                <div class="title-block">
                                    ...
                                    <div class="post-title">
                                        <h2><a style="text-shadow: none; color:black;" href="{{route('blog',[$post->id,$post->url])}}">{{$post->title}}</a></h2>
                                    </div>
