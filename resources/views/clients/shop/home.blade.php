           ...
           <div id="rev_slider_1" class="rev_slider fullscreenbanner" data-version="5.4.5">
            <ul> 
                ...
                <li data-transition="boxslide">
                    ...
                    <img src="{{ url_assets('/shop/images/hp-1-slide-bg-1.jpg')}}" alt="slide-1" class="rev-slidebg">
                ...
                <li data-transition="boxslide">
                    <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
                    <img src="{{ url_assets('/shop/images/hp-1-slide-bg-2.jpg')}}" alt="slide-2" class="rev-slidebg">
                ...
                <li data-transition="boxslide">
                    <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
                    <img src="{{ url_assets('/shop/images/hp-1-slide-bg-3.jpg')}}" alt="slide-3" class="rev-slidebg">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="categories-detail lighting">
                            <a href="shop-full-width.html" class="images"><img src="{{ url_assets('/shop/images/hp-1-categories-1.jpg')}}" alt="Lighting"></a>
                            <div class="product">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="categories-detail furniture">
                            <a href="shop-full-width.html" class="images"><img src="{{ url_assets('/shop/images/hp-1-categories-2.jpg')}}" alt="Furniture"></a>
                            <div class="product">
                                <a href="shop-full-width.html">
                                    <span class="name">
                                        <span class="line">- </span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="categories-detail decoration">
                            <a href="shop-full-width.html" class="images"><img src="{{ url_assets('/shop/images/hp-1-categories-3.jpg')}}" alt="Decoration"></a>
                            <div class="product">
                                <a href="shop-full-width.html">
                                    <span class="name">
                                        <span class="line">- </span>
    ...
    <section class="featured-hp-1">
        <div class="container">
            <div class="featured-content woocommerce">
                <h2 class="special-heading">Производи</h2>
                                        ...
                                        <div class="woocommerce-LoopProduct-link">
                                            <div class="product-image container1">
                                                <a href="{{route('product', [$product->id, $product->url])}}" class="wp-post-image">
                                                    <img class="image-cover img1" src="{{\ImagesHelper::getProductImage($product)}}" alt="product">
                                                    {{-- <img class="image-secondary" src="{{ url_assets('/shop/images/hp-1-featured-11.jpg')}}" alt="product"> --}}
                                                </a>
                                                <div class="button1">
                                                    <a href="{{route('product', [$product->id, $product->url])}}">Преглед</a>
                                                </div>
                                                ...
                                                <div class="button add_to_cart_button" style="z-index: 9999;">
                                                    <a href="#">
                                                        <img src="{{ url_assets('/shop/images/shopping-cart-black-icon.png')}}" alt="cart">
                                                    </a>
                                                </div>
                                                <h5 class="woocommerce-loop-product__title"><a href="{{route('product', [$product->id, $product->url])}}">{{$product->title}}</a></h5>
                                                <span class="price">
                                                    <ins>
                                                        @if( \EasyShop\Models\Product::hasDiscount( $product->discount ) )                                        
                                                        <span class="woocommerce-Price-amount amount">
                                                            {{-- <span class="woocommerce-Price-currencySymbol">$</span> --}}
                                                            {{number_format(EasyShop\Models\Product::getPriceRetail1($product, false, 0) / \Session::get('selectedCurrencyDivider'), 0, ',', '.')}} {{\Session::get('selectedCurrency')}}
                                                        </span>
                                                        @else 
                                                            {{number_format($product->$myPriceGroup / \Session::get('selectedCurrencyDivider'), 2, ',', '.')}} {{\Session::get('selectedCurrency')}}
                                                        @endif
                                                    </ins>
                                                    {{-- <ins>
                                                        <span class="woocommerce-Price-amount amount">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 cl-sm-12 col-12">
                        <div class="banner-left">
                            <a href="#" class="bg-image">
                                <img src="{{ url_assets('/shop/images/hp-1-banner-1.jpg')}}" alt="banner">
                            </a>
                            <div class="info">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8 cl-sm-12 col-12">
                        <div class="banner-right">
                            <a href="#" class="bg-image">
                                <img src="{{ url_assets('/shop/images/hp-1-banner-2.jpg')}}" alt="banner">
                            </a>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 left-block">
                                <div class="images">
                                    <img src="{{ url_assets('/shop/images/hp-1-testimonials-1.png')}}" alt="testimonials">
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 left-block left-block-2">
                                <div class="images">
                                    <img src="{{ url_assets('/shop/images/hp-1-testimonials-2.png')}}" alt="testimonials">
                                </div>
                            </div>
                            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 right-block">
                                <div class="testimonials-detail">
            ...
            <div class="insta-content">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="insta-detail">
                            <a href="https://www.instagram.com/" class="insta-image">
                                <img src="{{ url_assets('/shop/images/hp-1-ig-1.jpg')}}" alt="insta-1">
                    ...
                    <div class="col">
                        <div class="insta-detail">
                            <a href="#" class="insta-image">
                                <img src="{{ url_assets('/shop/images/hp-1-ig-2.jpg')}}" alt="insta-2">
                                <div class="overlay"></div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="insta-detail">
                            <a href="#" class="insta-image">
                                <img src="{{ url_assets('/shop/images/hp-1-ig-3.jpg')}}" alt="insta-3">
                                <div class="overlay"></div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="insta-detail">
                            <a href="#" class="insta-image">
                                <img src="{{ url_assets('/shop/images/hp-1-ig-4.jpg')}}" alt="insta-4">
                                <div class="overlay"></div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="insta-detail">
                            <a href="#" class="insta-image">
                                <img src="{{ url_assets('/shop/images/hp-1-ig-5.jpg')}}" alt="insta-5">
                                <div class="overlay"></div>
                            </a>
                        </div>
                    </div>
