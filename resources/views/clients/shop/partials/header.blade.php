        ...
        <div id="js-navbar-fixed" class="menu-desktop">
            <div class="container-fluid">
                <div class="menu-desktop-inner">
                    <!-- Logo -->
                    <div class="logo">
                        <a href="index1.html"><img src="{{ url_assets('/shop/images/logo-black.png')}}" alt="logo"></a>
                    </div>
                    <!-- Main Menu -->
                    <nav class="main-menu">
                        <ul>
                            ...
                            <li class="menu-item mega-menu">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="sub-menu-item sub-menu-item-1">
                                        <figure>
                                            <img src="{{ url_assets('/shop/images/header-shop-images.png')}}" alt="shop">
                                        </figure>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="menu-item mega-menu mega-menu-1">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="sub-menu-item sub-menu-item-1">
                                        <figure>
                                            <img src="{{ url_assets('/shop/images/header-elements-images.png')}}" alt="elements">
                                        </figure>
                                    </li>
                                </ul>
                            </li> --}}
                            @foreach($menuCategories as $item)
                                <li class="menu-item mega-menu mega-menu-1" {{ url()->current() == route('category', [$item['id'], $item['url']]) ? 'class=open' : ''  }}>
                    ...
                    <div class="header-right">
                        ...
                        <div class="search-btn-wrap">
                            <button class="search-btn" data-toggle="modal" data-target="#searchModal">
                                <img src="{{ url_assets('/shop/images/header-icon-1.png')}}" alt="search">
                            </button>
                        </div>
                        <!-- Cart -->
                        <div class="site-header-cart">
                            <div class="cart-contents">
                                <img src="{{ url_assets('/shop/images/header-icon-2.png')}}" alt="cart">
                            </div>
                                    ...
                                    <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                        <li class="woocommerce-mini-cart-item mini_cart_item clearfix">
                                            <a class="product-image" href="#">
                                                <img src="{{ url_assets('/shop/images/hp-1-drop-cart-1.png')}}" alt="cart-1">
                                            </a>
                                        ...
                                        <li class="woocommerce-mini-cart-item mini_cart_item clearfix">
                                            <a class="product-image" href="#">
                                                <img src="{{ url_assets('/shop/images/hp-1-drop-cart-2.png')}}" alt="cart-2">
                                            </a>
                        ...
                        <div class="canvas canvas-btn-wrap">
                            <button class="canvas-images canvas-btn" data-toggle="modal" data-target="#canvasModal">
                                <img src="{{ url_assets('/shop/images/header-icon-3.png')}}" alt="canvas">
                            </button>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="canvas-content">
                                    <div class="logo">
                                        <a href="/"><img src="{{ url_assets('/shop/images/logo-black.png')}}" alt="logo"></a>
                                    </div>
                                    <div class="insta">
                                        <div class="insta-inner">
                                            <div class="images">
                                                <a href="#" class="images-inner">
                                                    ...
                                                    <img src="{{ url_assets('/shop/images/hp-1-canvas-1.jpg')}}" alt="insta">
                                                </a>
                                            </div>
                                            <div class="images">
                                                <a href="#" class="images-inner">
                                                    <div class="overlay"></div>
                                                    <img src="{{ url_assets('/shop/images/hp-1-canvas-2.jpg')}}" alt="insta">
                                                </a>
                                            </div>
                                            <div class="images">
                                                <a href="#" class="images-inner">
                                                    <div class="overlay"></div>
                                                    <img src="{{ url_assets('/shop/images/hp-1-canvas-3.jpg')}}" alt="insta">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="insta-inner">
                                            <div class="images">
                                                <a href="#" class="images-inner">
                                                    <div class="overlay"></div>
                                                    <img src="{{ url_assets('/shop/images/hp-1-canvas-4.jpg')}}" alt="insta">
                                                </a>
                                            </div>
                                            <div class="images">
                                                <a href="#" class="images-inner">
                                                    <div class="overlay"></div>
                                                    <img src="{{ url_assets('/shop/images/hp-1-canvas-5.jpg')}}" alt="insta">
                                                </a>
                                            </div>
                                            <div class="images">
                                                <a href="#" class="images-inner">
                                                    <div class="overlay"></div>
                                                    <img src="{{ url_assets('/shop/images/hp-1-canvas-6.jpg')}}" alt="insta">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="contact">
                                        ...
                                        <div class="contact-inner">
                                            ...
                                            <div class="contact-info">
                                                <span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5a1f2833397762681a3f223b372a363f74393537">[email&#160;protected]</a></span>
                                            </div>
                                        </div>
                                        <div class="contact-inner">
