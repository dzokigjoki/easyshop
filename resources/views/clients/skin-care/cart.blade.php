      ...
      <div class="container relative">
        <div class="row">
          ...
          <div class="ecommerce col-xs-12">
            ...
            <form data-form="" id="checkoutForm" method="POST" name="checkout" class="checkout ecommerce-checkout row" data-card-action="https://epay.halkbank.mk/fim/est3Dgate" data-cash-action="{{route('checksum.generate')}}">
              ...
              <div class="col-md-8" id="customer_details">
                <div>
                  ...
                  <p class="form-row form-row-last validate-required validate-phone" id="billing_phone_field">
                    ...
                    <input required minlength="9" value="@if(isset($formData) && isset($formData['Telephone'])){{$formData['Telephone']}}@else{{isset($user) ? $user->phone : ''}}@endif" class="input-text" type="text" id="Telephone" name="Telephone" placeholder="Телефон*" />
                  </p>
                ...
                <div class="order-review-wrap ecommerce-checkout-review-order" id="order_review">
                  <div id="payment" class="ecommerce-checkout-payment">
                    ...
                    <ul class="payment_methods methods">
                      <p class="p_paying">Начин на испорака</p>
                      <li class="payment_method_paypal">
                        <select class="country_to_state country_select" id="type_delivery" name="type_delivery">
                    ...
                    <ul class="payment_methods methods">
                      ...
                      <li class="payment_method_bacs">
                        ...
                        <label for="payment_method_bacs">
                          @if($key=="Кредитна/Дебитна картичка")
                          Картичка
                          @else
                          {{$i['display_name']}}
                          @endif
                    ...
                    <div class="form-row place-order" id="order-button">
                      <button class="btn btn-lg w-50" disabled type="submit" data-pay-button id="submit-contact">Нарачај</button>
                    </div>
                  </div>
                </div>
              </div> <!-- end col -->
...
<script>
  $(document).ready(function() {
    ...
    if ($("input[name='FirstName']").val() == "" || $("input[name='LastName']").val() == "" ||
      ...
      $("input[name='Telephone']").length < 9 || $("select[name='Country']").val() == "" || $("input[name='Address']").val() == "") {
      canSubmit = false;
    } else {
      canSubmit = true;
    }
  ...
  jQuery(function($) {
    ...
    $(':input').on('input', function() {
      ...
      if (firstName == "" || lastName == "" || email == "" || telephone == "" || telephone.length < 9 || country == "" || address == "") {
        canSubmit = false;
      } else {
        canSubmit = true;
      }
