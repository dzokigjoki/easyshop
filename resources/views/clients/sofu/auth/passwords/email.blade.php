...
@section('content')
<div class="container no-header-container pt-100 pb-30">
            ...
            <div class="box-lg">
                <div class="row" data-gutter="60">
                    ...
                    <div class="col-md-12 pb-35">
                        <h3 class="pb-30">Ресетирај ја лозинката</h3>
                        ...
                        <form method="POST" action="{{route('auth.email_password.post')}}" class="login-form cf-style-1"
                            ...
                            <div class="form-group">
                                ...
                                <input style="background: white; border: 1px solid rgba(0, 0, 0, 0.23);" type="email" name="email" id="email" class="border-radius-none form-control" />
                            </div>
                            <input class="btn btn-lg" type="submit" value="Ресетирај лозинка" />
                        </form>
                        <br />
                    </div>
                </div>
