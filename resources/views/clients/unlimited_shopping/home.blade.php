...
<main class="ps-main">
        ...
        <div class="row">
            <div class="banner-slider-container col-md-9 col-sm-12 col-xs-12 pl-0">
                <div class="slider-cont">
                    <a href="{{route('product', [4, 'slnchev-avtomatichen-ventilator-auto-cool'])}}" class="slider-element se-1 slide-bg-1" style='background-size: cover;'>
                    </a>
                    <a href="{{route('product', [15, 'elektricheska-chetka-za-izpravyane-na-kosa-straight-artefact'])}}" class="slider-element se-2 slide-bg-1" style='background-size: cover;'>
                    </a>
                    <a href="{{route('product', [2, 'nayser-dayser-nicer-dicer-plus'])}}" class="slider-element se-3 slide-bg-1" style='background-size: cover;'>
                    </a>
    ...
    <div class="header-services smaller-than-600">
        <div class="ps-services owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="7000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="false" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
            <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Бесплатна достава</strong></p>
            <p class="ps-service"><i class="fa fa-money"></i><strong>Најповолни цени</strong></p>
            <p class="ps-service"><i class="fa fa-check-circle"></i><strong>Висок квалитет</strong></p>
        </div>
    </div>
        ...
        <div class="ps-section--features-product ps-section masonry-root pb-40">
            <div class="ps-container">
                <div class="ps-section__header mb-50">
                    <h3 class="ps-section__title" data-mask="Најпродавани">Најпродавани</h3>
                </div>
    ...
    <div class="container-fluid mb-20">
        <div class="ps-section--features-product ps-section masonry-root pb-40">
            <div class="ps-container">
                <div class="ps-section__header mb-50">
                    <h3 class="ps-section__title" data-mask="Препорачани">Препорачани</h3>
                </div>
                <div class="ps-section__content pb-50">
    ...
    <div class="container-fluid pl-0 pr-0">
        <div class="ps-section--offer">
            <div class="ps-column"><a class="ps-offer" href="{{route('product', [5, 'trimer-ss-senzor-yes-finish-touch'])}}"><img src="{{url_assets('/unlimited_shopping/images/AKCIJA-01.jpg')}}" alt=""></a></div>
            <div class="ps-column"><a class="ps-offer" href="{{route('product', [6, 'chetka-za-pochistvane-na-kosmi-ot-domashni-lyubimci'])}}"><img src="{{url_assets('/unlimited_shopping/images/AKCIJA-02.jpg')}}" alt=""></a></div>
        </div>
