        ...
        <div class="ps-products-wrap pt-80 pb-80">
            <div class="ps-products search-cont" data-mh="product-listing">
                ...
                @if(!count($products))
                    ...
                    <div class="col-sm-12">
                        <h1 class="text-center naslov">Нема резултати од пребарувањето - "{{$search}}"</h1>
                    </div>
