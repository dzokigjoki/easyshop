    ...
    <div style="margin-top:100px;text-align: justify;" class="row margin-bottom-40">
        ...
        <div class="column width-12">
            <div style="text-align: center; margin: 0 auto;" class="shopping-cart-page text-center">
                ...
                <div>
                    <h2><strong>{{trans('watchstore.emptyCart')}}</strong></h2>
                    <br>
                    <a href="{{route('home')}}"><button class="hoverCrno button pill add-to-cart-button">{{trans('watchstore.startShopping')}}</button></a>
