            ...
            <div class="row mt-40">
                <div class="col-md-8 mb-40 ">
                    <form method="POST" action="{{route('kontakt-forma')}}">
                        ...
                        <textarea required name="message" id="message" placeholder="Порака*" rows="9"></textarea>
                        <button type="submit" class="btn btn-lg btn_white btn-submit" data-contact-message-send>Испрати</button>
                    </form>
                </div> <!-- end col -->
                <div class="col-md-4 mb-40">
                    <div class="contact-item">
                        <h6>Адреса</h6>
                        <address>Yeppeuda inc.<br>
                            Улица<br>
                            Населено место<br>
                            Број</address>
                    </div> <!-- end address -->
                    ...
                    <div class="contact-item">
                        ...
                        <ul>
                            <li>
                                <i class="fa fa-envelope"></i><a href="mailto:/">info@yeppeuda.com</a>
                            </li>
                            <li>
                                <i class="fa fa-phone"></i><span>+389 75 233 882</span>
                            </li>
                            <li>
                                <i class="fa fa-print"></i><span>+389 75 233 882</span>
                            </li>
                        </ul>
                    </div> <!-- end information -->
